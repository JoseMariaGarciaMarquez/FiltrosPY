...
#--------Filtrar en el dominio de Fourier----------------------------------------------------------
    señal_f = []
    for i in range (len(HighPass)):
        señal_f.append(señal_ff[i]*HighPass[i])
...
#--------Gráficas----------------------------------------------------------------------------------
    ...
    ax[1,0].plot(F, HighPass)
    ax[1,0].set_title("Filtro pasa-altas")
    ax[1,0].grid()
    ...
    fig.suptitle("FILTRO PASA-ALTAS", fontsize = "20")
